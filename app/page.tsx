...
const INITIAL_DONORS: Donor[] = [
  { id: '1', firstName: 'Robert', lastName: 'Vance', amount: 1500, date: '2023-10-01', email: 'bob@vance.com', address: '123 Main St', city: 'Scranton', zip: '18503', age: 54, occupation: 'Business Owner', notes: 'Concerned about downtown patrols', isVolunteer: true, requestedSign: false, hasSign: true },
  { id: '2', firstName: 'Phyllis', lastName: 'Lapin', amount: 250, date: '2023-10-02', email: 'phyllis@dunder.com', address: '45 Maple Ave', city: 'Scranton', zip: '18503', age: 51, occupation: 'Sales', notes: '', isVolunteer: false, requestedSign: true, hasSign: false },
  { id: '3', firstName: 'Stanley', lastName: 'Hudson', amount: 50, date: '2023-10-05', email: 'stanley@dunder.com', address: '89 Oak Ln', city: 'Dunmore', zip: '18512', age: 62, occupation: 'Sales', notes: 'Sent via check', isVolunteer: false, requestedSign: false, hasSign: false },
  { id: '4', firstName: 'Michael', lastName: 'Scott', amount: 500, date: '2023-10-06', email: 'mscott@dunder.com', address: '12 Condominium Way', city: 'Scranton', zip: '18503', age: 45, occupation: 'Regional Manager', notes: 'Wants a badge', isVolunteer: true, requestedSign: true, hasSign: true },
  { id: '5', firstName: 'Dwight', lastName: 'Schrute', amount: 5000, date: '2023-10-07', email: 'dwight@farms.com', address: 'Schrute Farms', city: 'Honesdale', zip: '18431', age: 40, occupation: 'Farmer/Sheriff Deputy', notes: 'Maximum donation allowed', isVolunteer: true, requestedSign: true, hasSign: true },
  { id: '6', firstName: 'Jim', lastName: 'Halpert', amount: 100, date: '2023-10-08', email: 'jim@athleap.com', address: '55 Willow Dr', city: 'Philadelphia', zip: '19103', age: 35, occupation: 'Marketing', notes: '', isVolunteer: false, requestedSign: true, hasSign: true },
  { id: '7', firstName: 'Pam', lastName: 'Beesly', amount: 100, date: '2023-10-08', email: 'pam@art.com', address: '55 Willow Dr', city: 'Philadelphia', zip: '19103', age: 34, occupation: 'Office Admin', notes: '', isVolunteer: false, requestedSign: false, hasSign: false },
];
...
const App: React.FC = () => {
  ...
  const handleSaveDonor = (donorData: Donor) => {
    if (editingDonor) {
      setDonors(prev => prev.map(d => d.id === donorData.id ? donorData : d));
    } else {
    ...
    <div className="min-h-screen bg-slate-50 flex font-sans text-slate-900">
      ...
      <aside className="w-64 bg-slate-900 text-white flex-shrink-0 hidden md:flex flex-col fixed h-full z-10">
        <div className="h-16 flex items-center px-6 border-b border-slate-800">
          ...
          <div className="leading-tight">
            ...
            <span className="text-xs text-slate-400 uppercase tracking-widest">Command Center</span>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between group">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm">
                  ...
                  <p className="text-[10px] text-emerald-400 font-bold uppercase tracking-widest">Active Session</p>
              </div>
            </div>
            <button 
      ...
      <main className="flex-1 md:ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white shadow-sm border-b border-slate-200 flex items-center justify-between px-4 sm:px-8 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-4">
             <div className="hidden sm:flex flex-col items-end">
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Campaign Phase</span>
                <span className="text-xs font-bold text-sheriff-700">Primary Election</span>
             </div>
        ...
        <div className="p-4 sm:p-8 space-y-8 overflow-y-auto flex-1">
          ...
          {view === 'log' && (
            <FormsManager donors={donors} forms={forms} onSaveLogEntry={handleSaveLogEntry} />
          )}
        </div>
